...
struct command_info cmd_info[] =
{
	...
	{ "transfer",	do_transfer,		0,			POS_DEAD,	GM_IMPLEMENTOR	},
...
//	{ "shutdown",	do_shutdown,		0,			POS_DEAD,	GM_HIGH_WIZARD	},
...
#endif
#ifdef __SKILL_TREE__
	{ "skill_tree",	do_skill_tree,		0,		POS_DEAD,	GM_PLAYER },
#endif
	...
	{ "dice_system",	do_dice,		0,	POS_DEAD,	GM_HIGH_WIZARD	},
...
#endif
//	{ "search_in_shops",	do_search_in_shops,		0,		POS_DEAD,	GM_PLAYER	},
#ifdef ENABLE_HIDE_COSTUME_SYSTEM
	{ "costume_hide", do_costume_hide, 0, POS_DEAD, GM_PLAYER},
#endif
	{ "pacanele",		do_pacanele,		0,			POS_DEAD,	GM_PLAYER	},
	{ "gamble",		do_gamble,		0,			POS_DEAD,	GM_PLAYER	},
